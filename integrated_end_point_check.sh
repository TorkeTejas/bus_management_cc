...
declare -A services=(
  ...
  ["Agent Service"]="http://0.0.0.0:8006"
  ["Booking Service"]="http://0.0.0.0:8007"
)

declare -A endpoints=(
  ["API Gateway"]="/ GET:/bookings POST:/bookings GET:/buses POST:/users/register POST:/users/login GET:/agents POST:/agents/register POST:/agents/login"
  ...
  ["Agent Service"]="/ GET:/agents POST:/agents/register POST:/agents/login"
  ["Booking Service"]="/ GET:/bookings POST:/bookings"
)
